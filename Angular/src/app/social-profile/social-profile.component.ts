...
export class SocialProfileComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    //get local storage
    console.log(this.storedAccount);
    this.storedAccount = JSON.parse(localStorage.getItem('selectedProfile') || "{}"); 
    
    if (this.storedAccount.user1.username == this.decoded.username)
      this.theirUser = this.storedAccount.user2;
    else this.theirUser = this.storedAccount.user1;
